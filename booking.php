...
re.rn_emp_id ='" . $id . "'";
                    ...
                    <table class="table table-striped table-sm ">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center" colspan="3">ADULTS & CHILDREN</th>
                                <th scope="col" class="text-center" colspan="2">DATES OF STAY</th>
                                <th scope="col" class="text-center" colspan="2">ACCOMMODATIONS</th>
                            ...
                            <tr>
                                <th class="border-left">Adult</th>
                                <th class="border-left border-right">Children</th>
                                <th class="border-left border-right">Children Age</th>
                                <th class="border-left">Start Date</th>
                                <th class="border-left border-right">End Date</th>
                                <th class="border-left border-right">Rooms</th>

                                <th class="border-left border-right">Deal</th>
                                <th class="border-left border-right">Price</th>
                                <!-- <th class="border-left border-right">Facilities</th> -->
                        ...
                        <tbody>
                            ...
                            if ($type == 1) {
                                ...
                                $sql  = "SELECT * FROM rn_booking rb 
                            LEFT JOIN rn_hotel_details rhd ON rb.ref_rn_hotel_id = rhd.rn_hotel_id
                            LEFT JOIN rm_room rr ON rb.rn_room_type = rr.rn_room_id 
                            LEFT JOIN rn_customers rc ON rb.ref_rn_emp_id = rc.rn_cus_id WHERE rb.ref_rn_emp_id =";
    ...
    LEFT JOIN rn_hotel_details rhd ON rb.ref_rn_hotel_id = rhd.rn_hotel_id
    LEFT JOIN rm_room rr ON rb.rn_room_type = rr.rn_room_id 
    LEFT JOIN rn_customers rc ON rb.ref_rn_emp_id = rc.rn_cus_id ";
                            }
                            ...
                            foreach ($resultset as $rowData) {
                                $booking_id =  $rowData['rn_booking_id'];


                                if ($rowData['rn_booking_deail'] == '1') {
                                    $deel = "Breakfast Included";
                                    $price = $rowData['rn_room_breakfast'];
                                } elseif ($rowData['rn_booking_deail'] == '2') {
                                    $deel = "Half Board";
                                    $price = $rowData['rn_room_halfboard'];
                                } else {
                                    $deel = "Full Board";
                                    $price = $rowData['rn_room_fullboard'];
                                }
                                ...
                                if ($rowData["rn_room_pay_status"] == 1) {
                                    $isse = "Paid";
                                } else {
                                    $isse = "Pending";
                                }
                            ?>
                                <tr>
                                    <td><?php echo $i;
                                        ?></td>
                                    <td><?php echo $rowData["rn_cus_name"];
                                        ?></td>
                                    <td><?php echo $rowData["rn_hotel_name"];
                                        ?></td>
                                    <td><?php echo $rowData["rn_booking_adult"];
                                        ?></td>
                                    <td><?php echo $isse;
                                        ?></td>
                                    <td><?php echo $rowData["rn_booking_children"];
                                        ?></td>
                                    <td><?php echo $rowData["rn_booking_children_age"];
                                        ?></td>
                                    <td><?php echo $rowData["rn_booking_date_from"];
                                        ?></td>

                                    <td><?php echo $rowData["rn_booking_date_to"];
                                        ?></td>
