...
<head>
    ...
    <title>Travel Company Configuration</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <a class="btn" href="addTCompany.php"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i> Add Travel Company</a>
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sql  = "SELECT * FROM rn_hotel_travel_comapny 
                            LEFT JOIN rn_bank ON rn_bank_id = rn_hotel_trvel_com_ref_bank_id
                             WHERE rn_hotel_trvel_com_status = 1 ORDER BY rn_hotel_trvel_com_name ASC";
                            ...
                            foreach ($resultset as $rowData) {
                                $h_id =  $rowData['rn_hotel_trvel_com_id'];


                                if ($rowData["rn_hotel_trvel_com_status"] == 1) {
                                    $isse = "Active";
                                } else {
                                    $isse = "Inactive";
                                }
                            ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $rowData["rn_hotel_trvel_com_name"]; ?></td>
                                    <td><?php echo $rowData["rn_hotel_trvel_com_address"]; ?></td>
                                    <td><?php echo $rowData["rn_hotel_trvel_com_web_address"]; ?></td>
                                    <td><?php echo $rowData["rn_hotel_trvel_com_address"]; ?></td>
                                    <td><?php echo $rowData["rn_hotel_trvel_com_fax"]; ?></td>
                                    <td><?php echo $rowData["rn_bank_name"]; ?></td>
                                    <td><?php echo $rowData["rn_hotel_trvel_com_acc_no"]; ?></td>
                                    <td><?php echo $isse; ?></td>
                                    <td>
                                        <button class='btn' myid='". $rowData[' rn_hotel_id']."' onclick='tCompnUpdate(<?php echo $h_id; ?>);'><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></button>
                                        <button class='btn' onclick='tCompnDelete(<?php echo $h_id; ?>);'><i class="fa fa-trash fa-lg" aria-hidden="true"></i></button>
                                    </td>
                                </tr>
                            <?php $i++;
                            } ?>
                ...
                <?php if (isset($_GET['deteeOk'])) { ?>
                    <div class="alert alert-success deteeOk" role="alert">
...
<script>
    ...
    function tCompnUpdate(id) {
        window.location.href = 'editTCompany.php?companyId=' + id;
    }

    function tCompnDelete(id) {
        var file = 'travel'
        $.post('delete.php', {
            'id': id,
            'file': file
            ...
            header("refresh:20;url=travelCompany.php?deteeOk=OK");
        });
        location.reload();
    }
</script>