...
re.rn_emp_id ='" . $id . "'";
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form action="addTCompany.php" method="POST" name="hotel">
                    ...
                    <label>Name</label><br>
                    <input class="form-control" type="text" name="TCName" id="TCName" value="" required />
                    <br /><br />

                    <label>Address</label><br>
                    <textarea class="form-control" id="TCAddress" name="TCAddress" cols="60" required></textarea>
                    <br /><br />

                    <label>Telephone</label><br>
                    <input class="form-control" type="number" name="TCTep" id="TCTep" value="" required />
                    <br /><br />

                    <label>Fax No</label><br>
                    <input class="form-control" type="number" name="TCFax" id="TCFax" value="" />
                    <br /><br />

                    <label>Web Address</label><br>
                    <textarea class="form-control" id="TCWAddress" name="TCWAddress" cols="60" required></textarea>
                    <br /><br />
                    ...
                    <select class="form-control" name="TCbank" id="TCbank" required>
                        ...
                        <?php foreach ($resultset as $rowData) { ?>
                            <option value="<?php echo $rowData['rn_bank_id']; ?>"><?php echo $rowData['rn_bank_name']; ?> </option>
                        <?php } ?>
                    </select>
                    </select>
                    <br />
                    ...
                    <input class="form-control" type="text" name="TCAcc" id="TCAcc" value="" required />
                    <br /><br />
                    ...
                    <div class="mb-3 form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="activeCompany" name="activeCompany" checked>
...
if (isset($_POST["TCName"])) {
    ...
    $sql = "INSERT INTO rn_hotel_travel_comapny(rn_hotel_trvel_com_name,rn_hotel_trvel_com_address,rn_hotel_trvel_com_tp,rn_hotel_trvel_com_fax,rn_hotel_trvel_com_acc_no,rn_hotel_trvel_com_web_address, rn_hotel_trvel_com_status,rn_hotel_trvel_com_ref_bank_id) 
                             values ('" . $TCName . "','" . $TCAddress . "','" . $TCTep . "','" . $TCFax . "','" . $TCAcc . "','" . $TCWAddress . "', '" . $issue . "' , '" . $TCbank . "')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $sql_login = "INSERT INTO rn_login (rn_login_user_name,rn_login_user_password,rn_login_user_type, rn_login_status,rn_login_user_id,rn_login_user_issue_account) 
                            values ('" . $cussunm . "', '" . $cusspass . "', '4', '','" . $last_id . "', '" . $issue . "') ";
