            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class=comapny_designation>
                    ...
                    <form action="saveData.php" method="post">
                        ...
                        <?php if (isset($_GET['error_desi'])) { ?>

                            <p class="error_desi"><?php echo $_GET['error_desi']; ?></p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <?php
                                $sql  = "SELECT * FROM rn_designation rd   ORDER BY rd.rn_desin_name ASC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class='btn btn-success' myid='". $row[' rn_emp_id']."' onclick='staffUpdate(" . $my_id . ");'><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></button>
                                            <button class='btn btn-danger' onclick='staffDelete(" . $my_id . ");'>Delete</button>
                                        </td>
                                    </tr>
                                <?php $i++; } ?>
                            </tbody>
                ...
                <div class=comapny_employmentName>
                    <h3>Employment Name</h3>

                    <form action="saveData.php" method="post">

                        <div class="mb-3">
                            <label class="form-label">Employment Name</label>
                            <input type="text" class="form-control" id="rn_e_name_name" name="rn_e_name_name">

                        </div>

                        <?php if (isset($_GET['error_ename'])) { ?>

                            <p class="error_ename"><?php echo $_GET['error_ename']; ?></p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <?php
                                $sql  = "SELECT * FROM rn_employment_name  ORDER BY rn_e_name_name ASC";
                                $result = $conn->query($sql);
                                $resultset = array();
                                while ($row = $result->fetch_assoc()) {
                                    $resultset[] = $row;
