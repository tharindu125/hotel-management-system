        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Rooms Status</h1>
                </div>
                <a class="btn" href="addRoomStatus.php"><i class="fa fa-plus-circle fa-2x" aria-hidden="true"></i> Add New Rooms Status</a>
                <div class="table-responsive">
                    <table class="table table-striped table-sm ">
                        <thead>
                            <tr>
                                <th scope="col" rowspan="2">#</th>
                                <th scope="col" rowspan="2">Room No</th>
                        ...
                        <tbody>
                            <?php
                            $sql  = "SELECT *FROM rn_hotel_booking_room
                            LEFT JOIN rn_hotel_details rhd ON rhd.rn_hotel_id = ref_rn_hotel_id
                              LEFT JOIN rm_room rr ON rr.rn_room_id = ref_rn_room_id ORDER BY rn_hotel_booking_room_no ASC";
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $i;
                                        ?></td>
                                    <td><?php echo $rowData["rn_hotel_booking_room_no"];
                                        ?></td>
                                    ...
                                    <td><?php echo $rowData["rn_hotel_booking_room_bed"];
                                        ?></td>
                                    <td><?php echo $rowData["rn_hotel_booking_room_harf"];
                                        ?></td>
                                    <td><?php echo $rowData["rn_hotel_booking_room_full"];
                                        ?></td>
