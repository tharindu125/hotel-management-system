...
re.rn_emp_id ='" . $id . "'";
            ...
            <h2 class="add_new">Add New Hotel</h2>
                <form action="addHotel.php" method="POST" name="hotel">


                    <label>Name</label><br>
                    <input class="form-control" type="text" name="hName" id="hName" value="" required />
                    <br /><br />

                    <label>Address</label><br>
                    <textarea class="form-control" id="hAddress" name="hAddress" cols="60" required></textarea>
                    <br /><br />

                    <label>Telephone</label><br>
                    <input class="form-control" type="number" name="hTep" id="hTep" value="" required />
                    <br /><br />

                    <label>Fax No</label><br>
                    <input class="form-control" type="number" name="hFax" id="hFax" value="" required />
                    <br /><br />

                    <label>Web Address</label><br>
                    <textarea class="form-control" id="hWAddress" name="hWAddress" cols="60" required></textarea>
                    <br /><br />

                    <label>Discription</label><br>
                    <textarea class="form-control" id="hDis" name="hDis" cols="60" required></textarea>
                    <br /><br />

                    <div class="mb-3 form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="issue" name="issue" checked>
                        <label class="form-check-label" for="flexSwitchCheckChecked">Show Hotel</label>
                    </div>
...
if (isset($_POST["hName"])) {
    ...
    $sql = "INSERT INTO rn_hotel_details(rn_hotel_name,rn_hotel_address,rn_hotel_tp,rn_hotel_fax,rn_hotel_dis,rn_hotel_web_address, rn_hotel_status) 
                             values ('" . $hName . "', '" . $hAddress . "', '" . $hTep . "', '" . $hFax . "', '" . $hDis . "' , '" . $hWAddress . "', '" . $issue . "')";

    if ($conn->query($sql) === TRUE) {

        header("Location:hotelConfig.php");
