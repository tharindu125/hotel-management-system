    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <a class="btn" href="addCustomer.php"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i> Add New Customer</a>
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            if($type == 1){
                                $sql  = "SELECT * FROM rn_customers rc 
                                LEFT JOIN rn_nationality ON rc.rn_cus_nationality = nat_id
                                WHERE rc.rn_cus_id ='" . $id . "'
                                ORDER BY rc.rn_cus_name ASC";
                            }else{
                                $sql  = "SELECT * FROM rn_customers rc 
                                LEFT JOIN rn_nationality ON rc.rn_cus_nationality = nat_id
                                ORDER BY rc.rn_cus_name ASC";
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $rowData["rn_cus_new_id"]; ?></td>
                                    <td><?php echo $rowData["rn_cus_name"]; ?></td>
                                    <td><?php echo $rowData["rn_cus_nic"]; ?></td>
                                    <td><?php echo $rowData["nationality"]; ?></td>
                                    <td><?php echo $rowData["rn_cus_tp_no"]; ?></td>
                                    <td><?php echo $rowData["rn_cus_address"]; ?></td>
                                    <!-- <td><?php //echo $rowData["rn_desin_name"]; 
                                                ?></td>
                                        <td><?php //echo $rowData["rn_e_name_name"]; 
                                            ?></td>
                                        <td><?php //echo $rowData["rn_emp_address"]; 
                                            ?></td>
                                        <td><?php //echo $isse; 
                                            ?></td> -->
                                    ...
                                    <td>
                                        <!-- <button class='btn' myid='". $rowData[' rn_cus_id']."' onclick='staffUpdate(" . $my_id . ");'><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></button> -->
