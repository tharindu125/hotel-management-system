...
$sql_room  = "SELECT * FROM rm_room rr LEFT JOIN rn_hotel_details rhd ON rhd.rn_hotel_id = rr.ref_rn_hotel_id ORDER BY rn_room_name ASC";
$result = $conn->query($sql_room);
$resultset_room = array();
while ($row = $result->fetch_assoc()) {
    $resultset_room[] = $row;
}
?>
...
re.rn_emp_id ='" . $id . "'";
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <form action="addRoomStatus.php" method="POST" name="hotelRoomSt">

                    <h2 class="add_new">Add New Room Status</h2>
                    ...
                    <label>Room</label><br>
                    <select class="form-control" name="rroom" id="rroom" required>
                        <option value="">Select Room</option>
                        <?php foreach ($resultset_room as $rowData) { ?>
                            <option value="<?php echo $rowData['rn_room_id']; ?>"><?php echo $rowData['rn_room_name']; ?>/<?php echo $rowData['rn_hotel_name']; ?> </option>
                        <?php } ?>
                    </select>
                    </select>
                    <br />
                    ...
                    <input class="form-control" type="number" name="rmumber" id="rmumber" value="" required />
                    <br />
                    <br />
...
if (isset($_POST["rroom"])) {
    ...
    $rroom = $_POST["rroom"];
    $rhotel = $_POST["rhotel"];
    $rmumber = $_POST["rmumber"];


    $sql = "INSERT INTO rn_hotel_booking_room(ref_rn_hotel_id,ref_rn_room_id,rn_hotel_booking_room_bed,rn_hotel_booking_room_harf,rn_hotel_booking_room_full,rn_hotel_booking_room_status, rn_hotel_booking_room_final_status,rn_hotel_booking_room_no) 
                             values ('" . $rhotel . "', '" . $rroom . "',  '0', '0' , '0', '0', '0','" . $rmumber . "')";
