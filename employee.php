    ...
    <div class="container-fluid">
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    ...
                    <?php if ($check_config == 1) { ?>
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="employee.php">Employee Information</a></li>
                                <li><a class="dropdown-item" href="hotelConfig.php">Hotels & Resorts</a></li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <a class="btn" href="addStaffPage.php"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i> Add New Staff Member</a>
                <a class="btn" href="exportEmployeePdf.php"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i> Export</a>
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <?php
                                $sql  = "SELECT * FROM rn_employee re
                                LEFT JOIN rn_login rl ON re.rn_emp_id = rl.rn_login_user_id
                                ...
                                WHERE rl.rn_login_user_type IN ('0','3','5') ORDER BY re.rn_name ASC";
                                ...
                                foreach ($resultset as $rowData) {
                                    $my_id=  $rowData['rn_emp_id'];

                                    if($rowData["rn_login_user_issue_account"] ==1){
                                        $isse ="Account Issued";
                                    }else{
                                        $isse = "Un Issued";
                                    }
                                ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $rowData["rn_name"]; ?></td>
                                        <td><?php echo $rowData["rn_emp_no"]; ?></td>
                                        <td><?php echo $rowData["rn_emp_epf_no"]; ?></td>
                                        <td><?php echo $rowData["rn_emp_nic_no"]; ?></td>
                                        <td><?php echo $rowData["rn_emp_tp_no"]; ?></td>
                                        <td><?php echo $rowData["rn_desin_name"]; ?></td>
                                        <td><?php echo $rowData["rn_e_name_name"]; ?></td>
                                        <td><?php echo $rowData["rn_emp_address"]; ?></td>
                                        <td><?php echo $isse; ?></td>
                                        

                                        <td>
                                            <button class='btn' myid='". $rowData[' rn_emp_id']."' onclick='staffUpdate(" . $my_id . ");'><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></button>
                                            <button class='btn' onclick='staffDelete(" . $my_id . ");'><i class="fa fa-trash fa-lg" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                <?php $i++;
                                } ?>
